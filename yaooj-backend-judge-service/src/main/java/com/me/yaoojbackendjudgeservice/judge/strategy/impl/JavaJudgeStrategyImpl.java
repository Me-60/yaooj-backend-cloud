package com.me.yaoojbackendjudgeservice.judge.strategy.impl;
...
import com.me.yaoojbackendmodel.model.dto.question.JudgeConfig;
...
public class JavaJudgeStrategyImpl implements JudgeStrategy {
    ...
    public JudgeInfo executeJudge(JudgeContext judgeContext) {
        ...
        // 对于使用lombok的@Builder这个方法就会出现无法访问的类型，所以要注意使用这个注解
        ...
        // Java程序比其他语言程序运行时间就多了十秒钟（这里是举个例子，为了解决实际情况不同语言程序有不同的判题策略，这也是为啥有manage这个管理类）
        long Java_Program_Time_Cost = 1000L;
        if ((actualTime - Java_Program_Time_Cost) > timeLimit) {
